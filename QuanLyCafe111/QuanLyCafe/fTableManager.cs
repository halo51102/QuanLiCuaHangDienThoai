...
namespace QuanLyCafe
{
    public partial class fTableManager : Form
    {
        ...
        private void cb_Food_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                if (cb_Food.SelectedIndex == 0)
                    pictureBox1.Image = QuanLyCafe.Properties.Resources.ca_phe_sua;
                else if (cb_Food.SelectedIndex == 1)
                    pictureBox1.Image = QuanLyCafe.Properties.Resources.ca_phe_den;
                else pictureBox1.Image = QuanLyCafe.Properties.Resources.bac_xiu;
            }
            else if (cb_Category.SelectedIndex == 1)
            {
                if (cb_Food.SelectedIndex == 0)
                    pictureBox1.Image = QuanLyCafe.Properties.Resources.tra_dao;
                else if (cb_Food.SelectedIndex == 1)
                    pictureBox1.Image = QuanLyCafe.Properties.Resources.tra_chanh;
                else pictureBox1.Image = QuanLyCafe.Properties.Resources.tra_buoi;
            }
            else
            {
                if (cb_Food.SelectedIndex == 0)
                    pictureBox1.Image = QuanLyCafe.Properties.Resources.ep_cam;
                else if (cb_Food.SelectedIndex == 1)
                    pictureBox1.Image = QuanLyCafe.Properties.Resources.ep_tao;
                else pictureBox1.Image = QuanLyCafe.Properties.Resources.ep_thom;
            }
        }
